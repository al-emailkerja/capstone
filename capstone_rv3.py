...
with st.expander("NEET Berdasarkan Jenis Kelamin"):
    ...
    sns.barplot(data=df2, x='Year', y='NEET', hue='Sex', ax=ax2, palette="Paired")
...
st.markdown(
            ...
            - Keluarga sebagai garis terdepan bertanggung jawab penuh mengkondisikan anggota keluarganya yang masih tergolong usia produktif untuk tidak tergolong NEET dengan memperhatikan faktor-faktor pembentuk NEET.
